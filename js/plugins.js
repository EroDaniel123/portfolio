...
let getYTPVideoID = function (e) {
    let r, t;
    return e.indexOf("youtu.be") > 0 || e.indexOf("youtube.com/embed") > 0 ? r = (t = (r = e.substr(e.lastIndexOf("https://marketifythemes.net/") + 1, e.length)).indexOf("?list=") > 0 ? r.substr(r.lastIndexOf("="), r.length) : null) ? r.substr(0, r.lastIndexOf("?")) : r : e.indexOf("http") > -1 ? (r = e.match(/[\\?&]v=([^&#]*)/)[1], t = e.indexOf("list=") > 0 ? e.match(/[\\?&]list=([^&#]*)/)[1] : null) : t = (r = e.length > 15 ? null : e) ? null : e, {
        videoID: r,
        playlistID: t
    }
};
...
(function (e) {
    var y = !1,
        ...
        L = function () {
            ...
            return 0 < e.split("/").length ? e.split("https://marketifythemes.net/").slice(0, -1).join("https://marketifythemes.net/") + "/" : ""
        }();
